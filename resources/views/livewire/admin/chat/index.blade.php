<div class="space-y-3 w-full">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
            <h1 class="text-xl sm:text-2xl font-bold tracking-tight text-foreground">Chat Moderation</h1>
            <p class="text-xs text-muted">Review and moderate direct messages and community groups</p>
        </div>
    ...
    <div class="flex flex-col sm:flex-row items-center gap-3 bg-white p-3 rounded-2xl border border-border shadow-xs">
        <div class="relative flex-1 w-full">
            ...
            <input
                ...
                class="w-full rounded-xl border border-border bg-slate-50/50 py-2 pl-10 pr-4 text-xs font-medium text-slate-900 outline-none transition-all focus:bg-white focus:border-primary"
            />
        </div>
