                ...
                <form x-show="step === 'verify'" x-cloak x-on:submit.prevent="resetPassword" class="space-y-3.5">
                    <div class="space-y-1">
                        <div class="flex items-center justify-between">
                            ...
                            <button type="button" x-on:click="step = 'request'; error = ''; success = ''" class="text-[12px] font-medium text-primary hover:underline">
                        ...
                        <div class="flex items-center justify-between pt-1">
                            <span class="text-muted text-[12px]">{{ __('site.auth.didnt_receive') }}</span>
                            <button type="button" :disabled="resending" x-on:click="resendOtp" class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg border border-primary/20 bg-primary/5 text-[12px] font-bold text-primary hover:bg-primary/10 transition-colors disabled:opacity-50">
